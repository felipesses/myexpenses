...
import 'package:myexpenses/modules/savings/presentation/components/saving_card/saving_card.dart';
import 'package:myexpenses/modules/savings/presentation/controllers/saving_controller.dart';
import 'package:myexpenses/modules/savings/presentation/pages/add_saving_page.dart';
...
class _SavingsPageState extends State<SavingsPage> {
  ...
  void initState() {
    super.initState();
    date = widget.date;
    controller.getSavingsByMonth('1', widget.date);
  }
    ...
    return WillPopScope(
      ...
      child: Scaffold(
            ...
            Directionality(
              ...
              child: TextButton.icon(
                onPressed: () {
                  pushNewScreen(
                    context,
                    screen: AddSavingsPage(date: date),
                  );
                },
                style: ButtonStyle(
                  overlayColor:
        ...
        body: Observer(builder: (_) {
          List<SavingEntity>? list = controller.savingList;
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 6),
                  Text(
                    'Adicione uma economia no botão acima',
                    style: TextStyle(
                      fontFamily: 'San Francisco',
                      color: primary,
                      fontSize: 15,
